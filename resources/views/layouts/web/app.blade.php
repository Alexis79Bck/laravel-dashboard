...
<body>
                    ...
                    <div class="logo">
                        <a class="logo-wrap" href="index.html">
                            <img class="logo-img logo-img-main"
                                src="{{ asset('assets/images/alexis-mata-high-resolution-logo-transparent.png') }}"
                                alt="Asentus Logo">
                            <img class="logo-img logo-img-active" src="{{ asset('assets/images/alexis-mata-high-resolution-logo-transparent.png') }}"
                                alt="Asentus Logo">
                        </a>
                    </div>
                    <!-- End Logo -->
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="img-responsive" src="{{ asset('assets/images/web/1920x1080/01.jpg')}}" alt="Slider Image">
                <div class="container">
            ...
            <div class="item">
                <img class="img-responsive" src="{{ asset('assets/images/web/1920x1080/02.jpg')}}" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
    ...
    <div class="content-lg container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="{{ asset('assets/images/web/970x647/01.jpg')}}" alt="Latest Products Image">
                    </div>
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="{{ asset('assets/images/web/970x647/02.jpg')}}" alt="Latest Products Image">
                    </div>
                </div>
            ...
            <div class="col-sm-4 sm-margin-b-50">
                <div class="margin-b-20">
                    <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="{{ asset('assets/images/web/970x647/03.jpg')}}" alt="Latest Products Image">
                    </div>
                </div>
            ...
            <div class="swiper-slider swiper-clients">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/01.png')}}" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/02.png')}}" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/03.png')}}" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/04.png')}}" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/05.png')}}" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="{{ asset('assets/images/web/clients/06.png')}}" alt="Clients Logo">
                    </div>
                </div>
                <!-- End Swiper Wrapper -->
            </div>
    ...
    <div class="promo-section overflow-h">
        ...
        <div class="promo-section-img-right">
            <img class="img-responsive" src="{{ asset('assets/images/web/970x970/01.jpg')}}" alt="Content Image">
        </div>
    </div>
    <!-- End Promo Section -->
            ...
            <div class="masonry-grid">
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8">
                    ...
                    <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="{{ asset('assets/images/web/800x400/01.jpg')}}" alt="Portfolio Image">
                        </div>
                ...
                <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                    ...
                    <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="{{ asset('assets/images/web/397x400/01.jpg')}}" alt="Portfolio Image">
                        </div>
                        <div class="work-content">
                ...
                <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                    ...
                    <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="{{ asset('assets/images/web/397x300/01.jpg')}}" alt="Portfolio Image">
                        </div>
                        <div class="work-content">
                            <h3 class="color-white margin-b-5">Clean Design</h3>
                            <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                ...
                <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                    ...
                    <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".4s">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="{{ asset('assets/images/web/397x300/02.jpg')}}" alt="Portfolio Image">
                        </div>
                        <div class="work-content">
                            <h3 class="color-white margin-b-5">Clean Design</h3>
                            <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
                ...
                <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-4">
                    ...
                    <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".5s">
                        <div class="work-overlay">
                            <img class="full-width img-responsive" src="{{ asset('assets/images/web/397x300/03.jpg')}}" alt="Portfolio Image">
                        </div>
                        <div class="work-content">
                            <h3 class="color-white margin-b-5">Clean Design</h3>
                            <p class="color-white margin-b-0">Lorem ipsum dolor sit amet consectetur adipiscing</p>
