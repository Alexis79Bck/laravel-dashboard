                    ...
                    <div class="menu-container">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="index.html">
                                <img class="logo-img logo-img-main" src="{{asset('assets/images/alexis-mata-high-resolution-logo-transparent.png')}}" alt="Asentus Logo">
                                <img class="logo-img logo-img-active" src="{{ asset('assets/images/logo-dark.png')}}" alt="Asentus Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
